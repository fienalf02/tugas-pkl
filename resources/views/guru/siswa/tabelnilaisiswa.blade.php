...
<body class="animsition">
  ...
  <div class="main-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-header " action="{{ route('siswa.searchnilaiguru') }}" method="GET" style="float: right">
                        {{ csrf_field() }}
                                ...
                                @foreach($siswa as $s)
                                    <tr class="tr-shadow">
                                        ...
                                        <div class="table-data-feature">
                                                <a href="{{ route('nilai.showguru', $s->id_siswa) }}" class="item" data-toggle="tooltip" data-placement="top" title="Nilai">
    ...
    function myFunction() {
        ...
        document.location.href='tabelnilaisiswaguru?search='+x;        
    }
    </script>
