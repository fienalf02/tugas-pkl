                                     ...
                                     <div class="card-body card-block">
                                        <div class="row form-group">
                                         ...
                                         <div class="col-12 col-md-8">
                                             <input type="text" id="company" name="kelas" placeholder="Masukkan Kelas" class="form-control">
                                         </div>
                                     </div>
                                     <div class="row form-group">
                                                <div class="col col-md-4">
                                        ...
                                        <div class="col-12 col-md-8">
                                            <input type="number" id="company" name="urutan" placeholder="Masukkan Urutan" class="form-control">
                                        </div>
                                    </div>
