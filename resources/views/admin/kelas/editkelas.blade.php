                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="card-body card-block">
                                         <div class="row form-group">
                                             ...
                                             <label for="company" class=" form-control-label">Kelas</label>
                                         </div>
                                         <div class="col-12 col-md-8">
                                             <input type="text" id="company" name="kelas" placeholder="Masukkan Kelas" class="form-control" value="{{$k->kelas}}">
                                         </div>
                                     </div>
                                     <div class="row form-group">
                                                <div class="col col-md-4">
                                                ...
                                                <div class="col-3">
                                                    <select name="id_jurusan" id="select" class="form-control">
                                                        ...
                                                        <option value="{{ $j->id }}" {{ $j->id == $k->id_jurusan ? 'selected':'' }}>{{$j->jurusan}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-4">
                                            <label for="company" class=" form-control-label">Urutan</label>
                                        </div>
                                        <div class="col-12 col-md-8">
                                             <input type="text" id="company" name="urutan" placeholder="Masukkan Urutan" class="form-control" value="{{$k->urutan}}">
                                         </div>
                                     </div>
