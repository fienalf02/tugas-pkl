            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-header " action="{{ route('siswa.searchspp') }}" method="GET" style="float: right">
                        {{ csrf_field() }}
                                ...
                                @foreach($siswa as $s)
                                    <tr class="tr-shadow">
                                        ...
                                        <div class="table-data-feature">
                                                <a href="{{ route('pembayaran.show', $s->id_siswa) }}" class="item" data-toggle="tooltip" data-placement="top" title="SPP">
