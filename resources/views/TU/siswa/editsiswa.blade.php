                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check-inline form-check">
                                                        <label for="P" class="form-check-label ">
                                                            <input type="radio" id="P" value="Perempuan" class="form-check-input" name="JK" {{ $s->JK == 'Perempuan' ? 'checked' : ''}}>Perempuan
                                                        </label> &nbsp &nbsp
                                                        <label for="L" class="form-check-label ">
                                                            <input type="radio" id="L" value="Laki-laki" class="form-check-input" name="JK" {{ $s->JK == 'Laki-laki' ? 'checked' : ''}}>Laki-laki
                                                        </label>
                                                    </div>
                                                </div></div>
                                                <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-5">
                                                    <select name="id_guru" id="select" class="form-control">
                                                        <option value="">-Pilihan-</option>
                                                        @foreach($guru as $g)
                                                        <option value="{{ $g->id }}" {{$g->id == $s->id_kelas ? 'selected':'' }}>{{ $g->nama_guru }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
